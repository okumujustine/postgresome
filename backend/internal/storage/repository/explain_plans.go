...
func ListExplainPlans(ctx context.Context, pool *pgxpool.Pool, databaseInstanceID string) (ExplainPlansSnapshot, error) {
	return listExplainPlansSnapshot(ctx, pool, listExplainPlansSQL, databaseInstanceID)
}

func ListExplainPlansAt(ctx context.Context, pool *pgxpool.Pool, databaseInstanceID string, collectedAt time.Time) (ExplainPlansSnapshot, error) {
	return listExplainPlansSnapshot(ctx, pool, listExplainPlansAtSQL, databaseInstanceID, collectedAt)
}

func listExplainPlansSnapshot(ctx context.Context, pool *pgxpool.Pool, sql string, args ...any) (ExplainPlansSnapshot, error) {

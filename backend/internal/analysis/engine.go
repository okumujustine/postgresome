...
import "github.com/okumujustine/postgresome/backend/internal/metrics"

// MetricRule inspects database stats and deltas and reports zero or more
// findings. Concrete rules are implemented in backend/internal/analysis/rules
// and satisfy this interface structurally. They can be registered with an
...
// backend/internal/analysis/rules and satisfy this interface structurally.
